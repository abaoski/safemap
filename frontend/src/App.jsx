...
function App() {
  ...
  const SEARCHABLE_LOCATIONS = [
    { name: 'Gensan Medical Center', type: 'hospital', contact: '887-9898', lat: 6.082848378647546, lng: 125.14814878609288 },
    { name: 'St. Elizabeth Hospital', type: 'hospital', contact: '552-3162', lat: 6.1186906805198, lng: 125.17990092527259 },
    { name: 'Mindanao Medical Center', type: 'hospital', contact: '553-8207', lat: 6.128140973066608, lng: 125.16013162335923 },
    { name: 'Dadiangas Medical Center', type: 'hospital', contact: '0917-190-2561', lat: 6.125146051208208, lng: 125.17780208294442 },
    { name: 'Sarangani Bay Specialists Medical Center', type: 'hospital', contact: '887-8888', lat: 6.119403451074248, lng: 125.14686598109384 },
    { name: 'Gensan Doctors Hospital', type: 'hospital', contact: '250-2777', lat: 6.1205193798244775, lng: 125.17829398294444 },
    { name: 'Dr. Jorge P. Royeca City Hospital', type: 'hospital', contact: '552-2811', lat: 6.1260614210312925, lng: 125.18573462712328 },
    { name: 'GSC Police Office', type: 'police', contact: '552-5573', lat: 6.110370865940478, lng: 125.16682861271755 },
    { name: 'Police Station 1 (Dad. East)', type: 'police', contact: '0998-598-7208', lat: 6.11432864656382, lng: 125.17065885410874 },
    { name: 'Police Station 2 (Makar Wharf)', type: 'police', contact: '0918-921-3580', lat: 6.094686794224281, lng: 125.1546590847949 },
    { name: 'Police Station 3 (Lagao)', type: 'police', contact: '0998-598-7212', lat: 6.128284606756957, lng: 125.19698807712341 },
    { name: 'Police Station 4 (San Isidro)', type: 'police', contact: '0998-598-7214', lat: 6.138473907635937, lng: 125.16834834246667 },
    { name: 'Police Station 5', type: 'police', contact: '0907-313-4517', lat: 6.07269034380546, lng: 125.14324851953891 },
    { name: 'Police Station 6 (Bula)', type: 'police', contact: '0998-598-7218', lat: 6.10762945266241, lng: 125.1892411829445 },
    { name: 'Police Station 7 (Fatima)', type: 'police', contact: '0998-598-7220', lat: 6.076678872414175, lng: 125.12008103658187 },
    { name: 'Bureau of Fire Protection (BFP)', type: 'fire', contact: '552-1160', lat: 6.115633495787534, lng: 125.1731673237921 },
  ...
  const handleAIChatClick = () => {
    // Dispatch custom event that ChatWidget will listen for
              ...
              {searchLocations(searchQuery).map((loc, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-500 capitalize">{loc.type} • {loc.contact}</div>
                  </div>
                </button>
              ))}
            </div>
          ...
          {selectedLocation && (
            <div className="absolute left-4 right-4 top-[110px] max-w-md mx-auto bg-white rounded-lg shadow-lg border border-gray-200 p-3 z-[1000]">
              <div className="flex items-center gap-2">
                <span className="text-lg">
                  {selectedLocation.type === 'hospital' ? '🏥' : selectedLocation.type === 'police' ? '👮' : selectedLocation.type === 'fire' ? '🚒' : '🚑'}
                </span>
