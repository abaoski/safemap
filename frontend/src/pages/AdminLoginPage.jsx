        ...
        <div className="min-h-screen w-full flex flex-col font-['DM_Sans'] bg-[#ebf2fb]">
            ...
            <div className="relative flex-1 flex flex-col items-center justify-center min-h-[30vh]">
                ...
                <img
                    src={logoImg}
                    alt="SafeMap"
                    className="w-56 md:w-64 object-contain z-10 mb-8"
                />
            </div>
          ...
          */}
                    <path
                        fill="#b4c7e6"
                        d="M0,100 Q720,-60 1440,100 L1440,220 L0,220 Z"></path>
                    <path
                        fill="#89a8d9"
                        d="M0,130 Q720,-30 1440,130 L1440,220 L0,220 Z"></path>
                    <path
                        fill="#5377c3"
                        d="M0,160 Q720,0 1440,160 L1440,220 L0,220 Z"></path>
                    <path
                        fill="#233f8e"
                        d="M0,190 Q720,30 1440,190 L1440,220 L0,220 Z"></path>
                </svg>
            </div>
            ...
            <div className="w-full bg-[#233f8e] shrink-0">
                <div className="w-full bg-white rounded-t-[40px] pt-10 pb-12 px-6 min-h-[50vh]">
                    <div className="w-full max-w-sm mx-auto">
                        {/* Welcome Text */}
                        <div className="mb-8">
                            <h1 className="text-[26px] font-bold text-zinc-800 leading-tight">
                                Welcome Back!
                            </h1>
                            <p className="text-[14px] text-gray-500 mt-1">
                                Authorized LGU Officers only
                            </p>
                        </div>
                        ...
                        <form
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <a
                                        href="#"
                                        className="text-[#102d7e] text-[12px] font-bold hover:underline"
                                        tabIndex={-1}>
                                        Forgot Password?
                                    </a>
                                </div>
                            ...
                            {/* Error Message */}
                            {error && (
                                <div className="p-3 bg-red-50 border border-red-100 text-red-600 text-[13px] rounded-lg">
                                    {error}
                                </div>
                            )}
