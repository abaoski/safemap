    ...
    return (
        <div className="w-full h-screen bg-slate-50 pb-20 overflow-y-auto">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-gray-500 text-sm font-normal font-['DM_Sans']">
                                Dedicated support for victims of violence
            ...
            <div className="w-full max-w-md mx-auto px-4 mt-8">
                <h3 className="text-neutral-600 text-sm font-bold font-['DM_Sans'] tracking-tight mb-5">
                    Emergency Hotlines
                </h3>
                ...
                <div className="w-full h-64 bg-blue-50 rounded-[10px] shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08)] outline-solid outline-[0.50px] outline-offset-[-0.50px] outline-blue-600 overflow-hidden p-5">
                    <div className="flex items-end gap-3 mb-4">
                        <svg
                            ...
                            className="w-5 h-5">
                            <path
                                d="M10 2L2 6V10C2 15 6.5 18.5 10 19.5C13.5 18.5 18 15 18 10V6L10 2Z"
                                fill="#1A3A8F"
                            />
                        </svg>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <p className="text-justify text-gray-400 text-xs font-normal font-['DM_Sans']">
                                You will be connected to a trained female
                                officer or social worker who specializes in VAWC
                                cases.
                            </p>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <p className="text-justify text-gray-400 text-xs font-normal font-['DM_Sans']">
                                Your conversation is strictly confidential and
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <p className="text-justify text-gray-400 text-xs font-normal font-['DM_Sans']">
                                They will provide immediate safety guidance,
                                legal advice, or dispatch help if needed.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full max-w-md mx-auto px-4 mt-8">
                <button className="w-full h-14 bg-blue-900 rounded-2xl inline-flex justify-center items-center gap-2.5">
                    <div className="text-white text-base font-bold font-['DM_Sans'] tracking-tight">
                        Find Nearest WCPD Desk
                    </div>
                </button>
