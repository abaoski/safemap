...
export default function HelpPage() {
  ...
  const getDisplayContacts = () => {
    ...
    const prioritized = emergencyContacts.filter(cat => 
      priorityCategories.includes(cat.category)
    )
  ...
  return (
    <div className="w-full h-screen bg-slate-50 overflow-y-auto">
      ...
      <div className="w-full max-w-md mx-auto px-4 mt-4">
        <h1 className="text-zinc-800 text-lg font-extrabold font-['DM_Sans'] tracking-tight text-center">VAWC Support</h1>
      </div>
        ...
        <div className="w-full h-48 bg-blue-50 rounded-2xl shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08)] outline outline-[0.50px] outline-offset-[-0.50px] outline-blue-600 overflow-hidden p-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col gap-2">
              <h2 className="text-blue-900 text-xl font-extrabold font-['DM_Sans'] tracking-tight">Women and Children Protection Center</h2>
              <p className="text-gray-500 text-sm font-normal font-['DM_Sans']">Dedicated support for victims of violence against women and their children.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-md mx-auto px-4 mt-8">
        <div className="w-full h-64 bg-blue-50 rounded-[10px] shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08)] outline outline-[0.50px] outline-offset-[-0.50px] outline-blue-600 overflow-hidden p-5">
          <div className="flex items-end gap-3 mb-4">
            ...
            <div className="text-blue-900 text-base font-semibold font-['DM_Sans'] tracking-tight">What to expect when you call</div>
          </div>
      ...
      <div className="w-full max-w-md mx-auto px-4 mt-8">
        ...
        <p className="text-center text-gray-400 text-xs font-normal font-['DM_Sans'] mt-2 mb-6">Navigate to the closest Women & Children Protection Desk</p>
      </div>
