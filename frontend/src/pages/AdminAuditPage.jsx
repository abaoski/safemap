  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 overflow-x-hidden flex flex-col items-center">
      ...
      <div className="w-full max-w-sm px-4 mt-4">
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 text-center">
            ...
            <div className="text-lg font-extrabold font-['DM_Sans'] text-purple-600">{auditStats.submissions}</div>
            <div className="text-[8px] font-bold font-['DM_Sans'] uppercase text-gray-400">Submitted</div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 text-center">
            <Clock className="w-5 h-5 text-yellow-500 mx-auto mb-1" />
            <div className="text-lg font-extrabold font-['DM_Sans'] text-yellow-600">{auditStats.pending}</div>
            <div className="text-[8px] font-bold font-['DM_Sans'] uppercase text-gray-400">Pending</div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 text-center">
            <CheckCircle className="w-5 h-5 text-green-500 mx-auto mb-1" />
            <div className="text-lg font-extrabold font-['DM_Sans'] text-green-600">{auditStats.approvals}</div>
        ...
        <div className="grid grid-cols-2 gap-2 mt-2">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 text-center">
            ...
            <div className="text-lg font-extrabold font-['DM_Sans'] text-red-500">{auditStats.dismissals}</div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 text-center">
            ...
            <div className="text-lg font-extrabold font-['DM_Sans'] text-green-600">{auditStats.verifications}</div>
      ...
      <div className="w-full max-w-sm px-4 mt-5 space-y-5">
        {loading ? (
          <div className="text-center py-12 text-gray-400 text-sm font-['DM_Sans']">Loading audit logs...</div>
