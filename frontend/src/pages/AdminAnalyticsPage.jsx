    ...
    <div className="w-full min-h-screen bg-slate-50 overflow-x-hidden flex flex-col items-center">
      ...
      <div className="w-full max-w-sm px-4 mt-4 space-y-3">
        ...
        <div className="w-full h-22 bg-white rounded-xl shadow-[0px_0px_4px_0px_rgba(0,0,0,0.08)] border-l-[6px] border-green-500 px-5 relative flex flex-col justify-center">
          <div className="text-gray-400 text-[11px] font-bold font-['DM_Sans'] uppercase">Approved</div>
          <div className="text-[#1e3a8a] text-[28px] font-extrabold font-['DM_Sans'] leading-none mt-1 mb-1">
      ...
      <div className="w-full max-w-sm px-4 mt-6 mb-8 space-y-4">
          ...
          <div className="w-full h-60 relative rounded-lg overflow-hidden border border-blue-100">
            ...
            <div className="absolute bottom-3 left-3 bg-[#1e3a8a] rounded-lg p-3 w-40 shadow-lg z-998">
              ...
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-white text-[10px] font-medium font-['DM_Sans']">Critical {">"} 15 cases</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-orange-400 shrink-0" />
                <span className="text-white text-[10px] font-medium font-['DM_Sans']">Warning 5-14 cases</span>
              </div>
            </div>
          </div>
        </div>
                ...
                return (
                  <div key={cat}>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="text-[#1e3a8a] text-[11px] font-extrabold font-['DM_Sans']">{pct}%</span>
                    </div>
        ...
        <div className="w-full bg-white rounded-xl shadow-sm border border-gray-100 py-4 px-5">
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-0 m-0 z-0">
              {[100, 80, 60, 40, 20, 0].map((val) => (
                <div key={val} className="w-full flex items-center gap-2">
                  <span className="text-gray-400 text-[9px] w-4 text-right mb-px">{val}</span>
          ...
          <div className="flex justify-around ml-6 mt-2 pb-1 border-b border-gray-200">
            <span className="text-gray-500 text-[9px] font-['DM_Sans']">Jan</span>
            <span className="text-gray-500 text-[9px] font-['DM_Sans']">Feb</span>
            <span className="text-gray-500 text-[9px] font-['DM_Sans']">Mar</span>
            <span className="text-gray-500 text-[9px] font-['DM_Sans']">Apr</span>
            <span className="text-gray-500 text-[9px] font-['DM_Sans']">May</span>
            <span className="text-gray-500 text-[9px] font-['DM_Sans']">Jun</span>
          </div>
        ...
        <div className="w-full bg-white rounded-xl shadow-sm border border-gray-100 py-4 px-5">
          ...
          <div className="w-full">
            <div className="grid grid-cols-[80px_1fr_60px_60px] gap-2 pb-2 border-b border-gray-100">
              <div className="text-gray-400 text-[9px] font-bold font-['DM_Sans']">Flag Time</div>
              <div className="text-gray-400 text-[9px] font-bold font-['DM_Sans']">Metric Type</div>
              <div className="text-gray-400 text-[9px] font-bold font-['DM_Sans']">Region</div>
              <div className="text-gray-400 text-[9px] font-bold font-['DM_Sans']">Severity</div>
            </div>
            ...
            <div className="grid grid-cols-[80px_1fr_60px_60px] gap-2 py-4 border-b border-gray-100 items-center">
              ...
              <div className="text-[#1e3a8a] text-[9px] font-medium font-['DM_Sans']">District 4</div>
              <div>
            ...
            <div className="grid grid-cols-[80px_1fr_60px_60px] gap-2 py-4 border-b border-gray-100 items-center">
              ...
              <div className="text-[#1e3a8a] text-[9px] font-medium font-['DM_Sans']">District 2</div>
              <div>
