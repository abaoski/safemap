    ...
    <div className="w-full h-screen bg-slate-50 overflow-y-auto">
      ...
      <div className="w-full max-w-md mx-auto px-4 flex flex-col items-center gap-3">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 text-base font-normal mt-2">
            Your security is our priority. Please review these essential guidelines before submitting your report.
          </p>
        </div>
      </div>
      ...
      <div className="w-full max-w-md mx-auto mt-8 px-4 flex flex-col gap-4">
        ...
        <div className="w-full h-auto bg-white rounded-2xl shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08)] outline-solid outline-1 -outline-offset-1 outline-gray-200 px-5 py-4 flex items-start gap-3.5">
          <Checkbox id="emergency" checked={emergencyChecked} onCheckedChange={setEmergencyChecked} className="mt-1" />
          <div className="flex flex-col gap-1">
            <label htmlFor="emergency" className="text-zinc-800 text-xs font-medium cursor-pointer">
              Emergency Protocol
            </label>
            <span className="text-gray-400 text-xs">
              If you are in immediate danger, call <span className="text-blue-900 font-bold">911</span> immediately.
            </span>
          </div>
        </div>
        ...
        {/* Privacy Rule */}
        <div className="w-full h-auto bg-white rounded-2xl shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08)] outline-solid outline-1 -outline-offset-1 outline-gray-200 px-5 py-4 flex items-start gap-3.5">
          <Checkbox id="privacy" checked={privacyChecked} onCheckedChange={setPrivacyChecked} className="mt-1" />
          <div className="flex flex-col gap-1">
            <label htmlFor="privacy" className="text-zinc-800 text-xs font-medium cursor-pointer">
              Privacy Rule
            </label>
            <span className="text-gray-400 text-xs">
              Your report will be treated with strict confidentiality. We never share your personal information.
            </span>
          </div>
        </div>
      </div>
