        ...
        {tabs.map((t) => (
          <button
            ...
            className={`rounded-xl p-3 text-center transition-colors ${
              statusFilter === t.key ? "bg-[#1f295b] shadow-md" : "bg-white shadow-sm border border-gray-100"
            }`}
          >
            <div
              className={`text-lg font-extrabold font-['DM_Sans'] ${statusFilter === t.key ? "text-white" : t.color}`}
            >
              {t.count}
            </div>
            <div
              className={`text-[8px] font-bold font-['DM_Sans'] uppercase ${
