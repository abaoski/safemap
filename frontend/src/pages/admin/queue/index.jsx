                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${
                                            ...
                                            selectedReport.status === 'approved_awareness' ? 'bg-green-100 text-green-600' :
                                            selectedReport.status === 'verified_pnp' ? 'bg-blue-100 text-blue-800' :
                                    ...
                                    <div className="flex flex-col items-end gap-1">
                                        <span className="text-[10px] text-gray-400 font-bold uppercase tracking-tight text-right">Severity</span>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="bg-gray-50 p-3 rounded-xl border border-gray-100">
                                        ...
                                        <p className="text-[10px] text-gray-500 font-bold uppercase">{selectedReport.category?.replace("_", " ")}</p>
                                    </div>
                                </div>
