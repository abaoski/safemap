    ...
    <AdminLayout activeTab="queue">
      ...
      <div className="w-full max-w-sm px-4 mt-5 space-y-3">
        {loading ? (
          ...
          filteredReports.map((report) => <QueueReportCard key={report.id} report={report} onView={handleView} />)
        )}
      </div>
        ...
        <div className="fixed inset-0 z-9999 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-4 border-b flex items-center justify-between bg-[#1f295b] text-white">
              <div>
                <h3 className="font-bold text-lg leading-tight">Report Details</h3>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center justify-between gap-4">
                      ...
                      className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${
                        selectedReport.status === "pending_review"
                          ...
                          : selectedReport.status === "in_progress"
                            ...
                            : selectedReport.status === "verified_pnp"
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      />
                      <span className="text-xs font-bold text-gray-700 capitalize">{selectedReport.severity}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-gray-400">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-tight">Title & Category</span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-gray-400">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-tight">Incident Description</span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-gray-400">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-tight">Location Details</span>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-3">
                    ...
                    {selectedReport.location?.address && (
                      <div className="pt-2 border-t border-gray-200 mt-2">
                        <span className="text-[10px] text-gray-400 font-bold block mb-1">SPECIFIC ADDRESS</span>
                        <p className="text-xs text-gray-600 leading-tight">{selectedReport.location.address}</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-3 pb-2">
                  <div className="flex items-center gap-2 text-gray-400">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-tight">Submission Date</span>
                  </div>
                ...
                <div className="space-y-3 pt-3">
                  <div className="flex items-center gap-2 text-gray-400">
                    <AlertCircle className="w-3.5 h-3.5" />
                    <span className="text-[10px] font-bold uppercase tracking-tight">Severity (Required)</span>
                  </div>
                  ...
                  <p className="text-[10px] text-gray-400">Select a severity to enable actions.</p>
                </div>
                ...
                <div className="space-y-4 pt-6 border-t border-gray-100">
                  ...
                  <div className="flex flex-col gap-3">
                    <div
                      className={`flex gap-3 transition-all duration-500 ease-in-out ${selectedSeverity ? "opacity-100 transform translate-y-0" : "opacity-40 grayscale pointer-events-none"}`}
                    >
                      {selectedReport?.status === "pending_review" && (
                        <>
                          <button
