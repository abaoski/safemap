function StatsCards({ stats }) {
    return (
        <div className="w-full max-w-sm px-4 mt-4 space-y-3">
            ...
            {/* Pending Review */}
            <div className="w-full h-[88px] bg-white rounded-xl shadow-[0px_0px_4px_0px_rgba(0,0,0,0.08)] border-l-[6px] border-amber-500 px-5 relative flex flex-col justify-center">
