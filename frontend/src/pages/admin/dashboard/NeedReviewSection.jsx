...
function NeedReviewSection({ reports: initialReports, loading }) {
    ...
    const handleQuickAction = async (id, action) => {
        ...
        const bodies = {
            resolve: { notes: "Verified by administrator", case_number: "ADMIN-RESOLVED" },
            dismiss: { reason: "Dismissed by admin" },
        }
                        ...
                        reports.slice(0, 5).map((report, idx) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`w-full bg-white rounded-xl shadow-[0px_2px_8px_rgba(0,0,0,0.04)] border-l-[4px] p-4 flex gap-3 ${getStatusColor(report.status)} cursor-pointer hover:bg-slate-50 transition-colors ${isProcessing ? 'opacity-50 pointer-events-none' : ''}`}
                                >
                                        ...
                                        <div className="flex items-center justify-between mt-1">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    className="h-7 px-3 bg-red-50 hover:bg-red-100 transition-colors rounded-lg text-red-500 text-[10px] font-bold font-['DM_Sans'] flex items-center justify-center min-w-[64px]"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    disabled={isProcessing}
                                                    className="h-7 px-3 bg-[#1f295b] hover:bg-[#151c3d] transition-colors rounded-lg text-white text-[10px] font-bold font-['DM_Sans'] flex items-center justify-center min-w-[64px]"
                                                >
