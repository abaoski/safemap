...
export default function DirectoryAddDialog({ isOpen, onClose, onAdd }) {
    ...
    const handleSubmit = (e) => {
        ...
        onAdd(newEntry)
        setFormData({ name: "", phone: "", type: "SOCIAL CARE", location: "", lat: "", lng: "" })
        onClose()
    }

    return (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
            <div className="bg-white rounded-3xl w-full max-w-[340px] overflow-hidden shadow-2xl relative">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="block text-slate-700 text-[11px] font-bold font-['DM_Sans'] uppercase tracking-wider mb-1.5">Organization Name *</label>
                        <input 
                            required
                            type="text" 
                    ...
                    <div className="flex gap-3">
                        <div className="flex-1">
                            <label className="block text-slate-700 text-[11px] font-bold font-['DM_Sans'] uppercase tracking-wider mb-1.5">Category Type</label>
                            <select 
                                value={formData.type}
                        ...
                        <div className="flex-1">
                            <label className="block text-slate-700 text-[11px] font-bold font-['DM_Sans'] uppercase tracking-wider mb-1.5">Contact *</label>
                    ...
                    <div className="pt-2 border-t border-slate-100">
                        <label className="block text-slate-700 text-[11px] font-bold font-['DM_Sans'] uppercase tracking-wider mb-1.5">Location Address</label>
                        ...
                        <div className="flex gap-3">
                            <div className="flex-1">
                                <label className="block text-slate-700 text-[11px] font-bold font-['DM_Sans'] uppercase tracking-wider mb-1.5">Latitude</label>
                                <input 
                                    type="text" 
                                    placeholder="Lat"
                                    value={formData.lat}
                            ...
                            <div className="flex-1">
                                <label className="block text-slate-700 text-[11px] font-bold font-['DM_Sans'] uppercase tracking-wider mb-1.5">Longitude</label>
                                <input 
                                    type="text" 
                                    placeholder="Lng"
                                    value={formData.lng}
                    ...
                    <div className="pt-4">
                        <button type="submit" className="w-full bg-[#1f295b] text-white py-3.5 rounded-xl font-bold font-['DM_Sans'] shadow-md shadow-[#1f295b]/30 hover:bg-[#151c3d] hover:shadow-lg transition-all active:scale-[0.98]">
                            Add to Directory
                        </button>
                    </div>
                </form>
